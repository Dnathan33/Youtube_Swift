...
class MenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    var horizontalBarLeftAnchorConstraint: NSLayoutConstraint?
        ...
        //adds white underline (horizontalBarView) on menubar icons
...
//       // puts the white underline (horizontalBarView) underneat icons
...
//        UIView.animate(withDuration: 0.75, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 1, options: .curveEaseOut, animations:{ self.layoutIfNeeded()}, completion: nil)
        ...
        // animates the white underline (horizontalBarView) to slide underneath icons
   ...
   func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: frame.width / 4.5, height: frame.height)
    }
